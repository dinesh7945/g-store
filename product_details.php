...
$get_product = "select * from products where prd_id = $product_id";
...
<section class="breadcrumb-section set-bg" data-setbg="img/breadcrumb.jpg">
    <div class="container">
        <div class="row">
            ...
            $get_product = "select * from categories where cat_id='$prod_cat'";
            // select products where product_id tbl colmn name - $product_id declare variable
            $run_products = mysqli_query($db, $get_product);
            while ($row_products = mysqli_fetch_array($run_products)) {
                $cat_i = $row_products['cat_id'];
                $cat_t = $row_products['cat_title'];
            }
            ?>
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    <h2><?php echo "$cat_t"; ?></h2>
                    <!-- <h2>Vegetable’s Package</h2> -->
                    <div class="breadcrumb__option">
                        <a href="index.php">Home</a>
                        <?php echo "<a href='products.php?cat=$cat_i'>$cat_t</a></li>";
                        ?>
                        <span><?php echo "$cat_t" ?> Package</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large" src="admin-area/product-images/<?php echo "$prod_img1" ?>" alt="">
                    </div>
                    <div class=" product__details__pic__slider owl-carousel">
                        <img data-imgbigurl="admin-area/product-images/<?php echo "$prod_img2"; ?>" src="admin-area/product-images/<?php echo "$prod_img2"; ?>" alt="">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__price">Rs.<?php echo "$prod_price "; ?></div>
