            ...
            <div class="categories__slider owl-carousel">
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="img/categories/cat-1.jpg">
                        <h5><a href="products.php?cat=4">Fresh Fruit</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="img/categories/cat-2.jpg">
                        <h5><a href="products.php?cat=4">Dried Fruit</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="img/categories/cat-3.jpg">
                        <h5><a href="products.php?cat=3 ">Vegetables</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="img/categories/cat-4.jpg">
                        <h5><a href="products.php?cat=6">drink fruits</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="img/categories/cat-5.jpg">
                        <h5><a href="products.php?cat=8">Meat</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="featured__controls">
                    <ul>
                        ...
                        <li data-filter=".oranges">New added</li>
                        <li data-filter=".fresh-meat">Non-Veg</li>
                        <li data-filter=".vegetables">Vegetables</li>
                        <li data-filter=".fastfood">Fruits</li>
                    </ul>
                </div>
                <p style="text-align: right;"><a href="products.php"> View All</a></p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="banner__pic">
                    <a href='products.php?cat=4'><img src="img/banner/banner-1.jpg" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="banner__pic">
                    <a href="products.php?cat=6"><img src="img/banner/banner-2.jpg" alt=""></a>
                </div>
            </div>
        </div>
    </div>
